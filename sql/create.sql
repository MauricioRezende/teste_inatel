...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 30-Mar-2020 às 22:05
...
CREATE TABLE IF NOT EXISTS `configuracao` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `PRECO_MAXIMO_PRODUTO` varchar(6) NOT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `configuracao` (`ID`, `PRECO_MAXIMO_PRODUTO`) VALUES
(1, '10.00');
...
INSERT INTO `risco` (`ID`, `DESCRICAO`, `DATA_HORA`) VALUES
(1, 'Asma', '2020-03-30 19:03:23'),
(2, 'Pressão alta', '2020-03-30 19:03:45'),
(3, 'Diabetes', '2020-03-30 19:04:47');
...
INSERT INTO `usuario` (`ID`, `NOME`, `CPF`, `CNPJ`, `SENHA`, `EMAIL`, `CELULAR`, `TELEFONE`, `ID_CIDADE`, `PERFIL`, `STATUS`, `DATA_HORA`) VALUES
(1, 'Administrador', '012.345.678-99', NULL, 'e10adc3949ba59abbe56e057f20f883e', 'adm@gmail.com', '(35) 9 9999-9999', NULL, NULL, 'adm', NULL, '2020-03-27 21:16:30');

-- --------------------------------------------------------

--
-- Estrutura da tabela `usuario_risco`
--

DROP TABLE IF EXISTS `usuario_risco`;
CREATE TABLE IF NOT EXISTS `usuario_risco` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_USUARIO` int(11) NOT NULL,
  `ID_RISCO` int(11) NOT NULL,
  `DATA_HORA` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `fk_risco` (`ID_RISCO`),
